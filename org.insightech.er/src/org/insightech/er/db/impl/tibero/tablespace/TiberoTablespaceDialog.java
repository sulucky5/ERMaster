package org.insightech.er.db.impl.tibero.tablespace;
...
public class TiberoTablespaceDialog extends TablespaceDialog {
	...
	protected TablespaceProperties setTablespaceProperties() {
		TiberoTablespaceProperties properties = new TiberoTablespaceProperties();
	...
	protected void setData(TablespaceProperties tablespaceProperties) {
		if (tablespaceProperties instanceof TiberoTablespaceProperties) {
			TiberoTablespaceProperties properties = (TiberoTablespaceProperties) tablespaceProperties;
